...
class StoreModel {
  ...
  StoreModel.fromJson(Map<String, dynamic> json) {
    ...
    wcfmPolicyTabTitle = json['policy_tab_title'];
    wcfmShippingPolicy = json['shipping_policy'];
    wcfmRefundPolicy = json['refund_policy'];
    wcfmCancellationPolicy = json['cancellation_policy'];
