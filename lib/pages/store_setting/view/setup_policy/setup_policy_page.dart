...
// View
import 'widget/policy_body.dart';

// Constants
import 'package:flutter_store_manager/constants/credentials.dart';

class SetupPolicyPage extends StatelessWidget {
  const SetupPolicyPage({Key? key}) : super(key: key);
  static const routeName = '/store-setup-policy';
  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: const StoreSetupPolicyBody(),
    );
  }
}
