...
// View
import 'widget/seo_body.dart';

// Constants
import 'package:flutter_store_manager/constants/credentials.dart';

class SetupSeoPage extends StatelessWidget {
  const SetupSeoPage({Key? key}) : super(key: key);
  static const routeName = '/store-setup-seo';
  @override
