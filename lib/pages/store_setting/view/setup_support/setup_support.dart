...
import 'widget/support_body.dart';

// Constants
import 'package:flutter_store_manager/constants/credentials.dart';

class SetupSupportPage extends StatelessWidget {
  const SetupSupportPage({Key? key}) : super(key: key);
  static const routeName = '/store-setup-support';
  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: const StoreSetupSupportBody(),
    );
  }
}
